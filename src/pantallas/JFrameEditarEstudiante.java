...
public class JFrameEditarEstudiante extends javax.swing.JFrame {
    ...
    public JFrameEditarEstudiante(JFrameEstudiantes padre) {
        initComponents();
        this.padre=padre;
    }
    ...
    private void crearNuevoEstudiante(){
        //El nuevo estudiante que se va crear, en esta ventana solo se creará 
        //estudiantes
        estudiante = new Estudiante();
        estudiante.setNombreCompleto(txtNombre.getText().trim());
        ...
        estudiante.setSexoBiologico(sexo);
        this.padre.agregarNuevoEstudiante(estudiante);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameEditarEstudiante(new JFrameEstudiantes(new JFrameClase(new JFrameGestorClases()))).setVisible(true);
            }
        });
    }
